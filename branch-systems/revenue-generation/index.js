...
router.post("/subscribe", async (req, res) => {
  ...
  console.log(
    `[SaaS] New subscription: ${tier} - $${pricingTiers[tier].price}/mo`,
  );
...
const apiPricing = {
  automation: {
    price: 0.01,
    description: "GitHub/Linear automation per action",
  },
  aiAnalysis: { price: 0.05, description: "AI analysis per request" },
  contentGen: { price: 0.1, description: "Content generation per article" },
...
const affiliatePrograms = {
  github: { commission: 0.3, description: "GitHub Actions marketplace" },
  linear: { commission: 0.2, description: "Linear referral program" },
  notion: { commission: 0.25, description: "Notion affiliate program" },
  openai: { commission: 0.1, description: "OpenAI API reselling" },
