...
ROUTES = {
    ...
    "github.ci_cancelled": generic_handler,
    "github.ci_timed_out": generic_handler,
    "github.ci_neutral": generic_handler,
    "github.pr_opened": generic_handler,
    "github.pr_reopened": generic_handler,
    "github.pr_synchronize": generic_handler,
    "github.pr_closed": generic_handler,
