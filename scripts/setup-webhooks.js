...
async function setupWebhooks() {
  ...
  const githubToken =
    ...
    (await prompt("GitHub Personal Access Token: "));
  const owner =
    process.env.GITHUB_USERNAME || (await prompt("GitHub Username/Org: "));
  ...
  const secret =
    ...
    (await prompt("Webhook Secret (generate a random string): "));
  ...
  try {
    ...
    console.log(
      "TITAN will receive real-time notifications for all GitHub events.\n",
    );
